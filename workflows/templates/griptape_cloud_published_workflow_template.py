...
top_level_unique_values_dict = {
    "d952dbe5-800c-4dec-a886-58f9a569670b": pickle.loads(b"\x80\x04\x89."),
    "1fd31c15-998b-4a69-b3cb-8674c7e54a57": pickle.loads(
        b"\x80\x04\x95\x0e\x00\x00\x00\x00\x00\x00\x00\x8c\nskateboard\x94."
    ),
    "8c1ed10f-1d41-4bf9-810b-0146073840eb": pickle.loads(
    ...
    "c0a19e15-4ef8-4f83-96c5-7734712607b1": pickle.loads(
        b"\x80\x04\x95\x08\x00\x00\x00\x00\x00\x00\x00\x8c\x04\\n\\n\x94."
    ),
    "87dfa916-f702-4690-93c7-052480303020": pickle.loads(
    ...
    "81df0436-3724-4519-8e77-0dd3c7a5788d": pickle.loads(
        b"\x80\x04\x95\x0b\x00\x00\x00\x00\x00\x00\x00\x8c\x07gpt-4.1\x94."
    ),
    "27b40cc4-c661-4e82-9797-21e8d2745295": pickle.loads(b"\x80\x04}\x94."),
    "a987dd01-7e90-42a6-9342-b49b0147539c": pickle.loads(b"\x80\x04\x95\x04\x00\x00\x00\x00\x00\x00\x00\x8c\x00\x94."),
    "a4b0107d-bf0d-4d28-b784-ebda04a6e475": pickle.loads(b"\x80\x04]\x94."),
    "691c108e-9b9b-48d8-82db-44839715d330": pickle.loads(b"\x80\x04]\x94."),
    "6f4e6184-6fa0-4c4e-a13f-b23ad9348702": pickle.loads(
        b"\x80\x04\x95\x10\x00\x00\x00\x00\x00\x00\x00\x8c\x0cseedream-4.5\x94."
    ),
    "69212678-daf6-4e86-a8f1-6b855dd238f3": pickle.loads(b"\x80\x04]\x94."),
    "a55b2392-8baf-4fe2-a54d-83e78b158d9c": pickle.loads(
        b"\x80\x04\x95\x06\x00\x00\x00\x00\x00\x00\x00\x8c\x022K\x94."
    ),
    "fe316ba4-2da9-4903-8d9c-32fcc9e73c20": pickle.loads(
        b"\x80\x04\x95\x06\x00\x00\x00\x00\x00\x00\x00J\xff\xff\xff\xff."
    ),
    "15628486-9135-493f-a579-d3e84880227a": pickle.loads(b"\x80\x04K\n."),
    "63471b96-a12a-4078-aaf2-75d276fd1afd": pickle.loads(
        b"\x80\x04\x95\n\x00\x00\x00\x00\x00\x00\x00G@\x04\x00\x00\x00\x00\x00\x00."
    ),
    "5329398a-218a-4fc4-ba42-75c1fadf1f74": pickle.loads(
    ...
    "0331ef2d-e679-45d9-ba67-5327992354ed": pickle.loads(
    ...
    "d3e1211b-0bb3-4518-99d6-63314de3f272": pickle.loads(
    ...
    "2fd0a7af-7421-4c14-9f26-073329f3a326": pickle.loads(
...
with GriptapeNodes.ContextManager().flow(flow0_name):
    node0_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                ...
                "tempId": "placing-1767980322092-l6jan9",
    ...
    with GriptapeNodes.ContextManager().node(node0_name):
        GriptapeNodes.handle_request(
            AddParameterToNodeRequest(
                ...
                tooltip="Enter text/string for prompt.",
                type="str",
                input_types=["str"],
                output_type="str",
    ...
    node2_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Agent",
            metadata={
                "position": {"x": 1221.5, "y": 928.1247767177401},
                "tempId": "placing-1767980394742-4ko2uw",
                "library_node_metadata": {
                    "category": "agents",
    ...
    node3_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                "position": {"x": 1895.07724076892, "y": 932},
                "tempId": "placing-1767980431215-rtbbo",
                "library_node_metadata": {
                    "category": "image",
    ...
    with GriptapeNodes.ContextManager().node(node3_name):
        GriptapeNodes.handle_request(
            AlterParameterGroupDetailsRequest(group_name="Status", ui_options={"collapsed": True}, initial_setup=True)
        )
    node4_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                "position": {"x": 2768.0107547629596, "y": 948.6247767177402},
                "tempId": "placing-1767980468862-m0twjm",
                "library_node_metadata": {
                    "category": "griptape_cloud/published_workflows",
    ...
    with GriptapeNodes.ContextManager().node(node4_name):
        GriptapeNodes.handle_request(
            AddParameterToNodeRequest(
                ...
                tooltip="Enter text/string for image_prompt.",
                type="str",
                input_types=["str"],
                output_type="str",
                ui_options={"is_custom": True, "is_user_added": True},
        ...
        GriptapeNodes.handle_request(
            AddParameterToNodeRequest(
                ...
                tooltip="Enter ImageArtifact for image. Accepts: ImageArtifact, ImageUrlArtifact.",
                type="ImageArtifact",
    ...
    node6_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                "position": {"x": 550, "y": 500.3831605083146},
    ...
    node7_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                "position": {"x": 2768.0107547629596, "y": 500.3831605083146},
    ...
    node8_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                "position": {"x": 2768.0107547629596, "y": 125.2367588211529},
    ...
    with GriptapeNodes.ContextManager().node(node0_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["d952dbe5-800c-4dec-a886-58f9a569670b"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="prompt",
                node_name=node0_name,
                value=top_level_unique_values_dict["1fd31c15-998b-4a69-b3cb-8674c7e54a57"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node1_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["8c1ed10f-1d41-4bf9-810b-0146073840eb"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node1_name,
                value=top_level_unique_values_dict["c0a19e15-4ef8-4f83-96c5-7734712607b1"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node1_name,
                value=top_level_unique_values_dict["87dfa916-f702-4690-93c7-052480303020"],
                initial_setup=True,
                is_output=False,
            )
        )
    ...
    with GriptapeNodes.ContextManager().node(node2_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["81df0436-3724-4519-8e77-0dd3c7a5788d"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node2_name,
                value=top_level_unique_values_dict["27b40cc4-c661-4e82-9797-21e8d2745295"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node2_name,
                value=top_level_unique_values_dict["a987dd01-7e90-42a6-9342-b49b0147539c"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node2_name,
                value=top_level_unique_values_dict["a4b0107d-bf0d-4d28-b784-ebda04a6e475"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node2_name,
                value=top_level_unique_values_dict["691c108e-9b9b-48d8-82db-44839715d330"],
                initial_setup=True,
                is_output=False,
            )
        )
    ...
    with GriptapeNodes.ContextManager().node(node3_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["6f4e6184-6fa0-4c4e-a13f-b23ad9348702"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node3_name,
                value=top_level_unique_values_dict["69212678-daf6-4e86-a8f1-6b855dd238f3"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="size",
                node_name=node3_name,
                value=top_level_unique_values_dict["a55b2392-8baf-4fe2-a54d-83e78b158d9c"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="seed",
                node_name=node3_name,
                value=top_level_unique_values_dict["fe316ba4-2da9-4903-8d9c-32fcc9e73c20"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node3_name,
                value=top_level_unique_values_dict["15628486-9135-493f-a579-d3e84880227a"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node3_name,
                value=top_level_unique_values_dict["63471b96-a12a-4078-aaf2-75d276fd1afd"],
                initial_setup=True,
                is_output=False,
            )
        )
    ...
    with GriptapeNodes.ContextManager().node(node5_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["5329398a-218a-4fc4-ba42-75c1fadf1f74"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node6_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["0331ef2d-e679-45d9-ba67-5327992354ed"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node7_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["d3e1211b-0bb3-4518-99d6-63314de3f272"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node8_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["2fd0a7af-7421-4c14-9f26-073329f3a326"],
                initial_setup=True,
                is_output=False,
            )
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--structure_description", default=None, help="The description for the Griptape Cloud Structure."
    )
    parser.add_argument(
        "--enable_webhook_integration", default=None, help="Whether to enable a webhook integration for the Structure."
    )
